...
| Thinking mode | Judge + synthesize thinking mode — tested and **reverted** (5-10x latency, schema failures, same verdict quality as calibration rules alone) | **REVERTED** | 2026-03-25 |
